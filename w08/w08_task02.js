function main()
{
    ...
    {
        var S = i / 255.0; // [0,1]
        var R = Math.max( 1.0, 0.0 );
        var G = Math.max( Math.cos( ( 1.0 - S  ) * Math.PI ), 0.0 );
        var B = Math.max( Math.cos( ( 1.0 - S )* Math.PI ), 0.0 );
    ...
    {
        var id = faces[i];
        var S0 = Math.floor((255/0.7)*(scalars[ id[0]] -0.1));
        var S1 = Math.floor((255/0.7)*(scalars[ id[1]] -0.1));
        var S2 = Math.floor((255/0.7)*(scalars[ id[2]] -0.1));
